  ...
  <div
    ...
    >
      ...
      <div className="w-full md:w-1/2 flex pt-16 md:pb-0 pb-[22rem] bg-[#f1f5f9] md:bg-transparent flex-col justify-center text-center px-4 md:text-left md:pl-10 md:pr-[6rem] md:mt-[-8rem] absolute left-0">
        ...
        <button className="flex ml-[8rem] md:ml-0 bg-purple-700 text-[0.95rem] mt-[1.5rem] text-white px-6 w-[38%] md:w-[27%] py-[0.4rem] rounded-full hover:bg-purple-800 transition shadow-lg">
            Start for free
            </button>
      </div>
